...
// sub-menu tiêu chuẩn chất lượng
    ...
    <div class="container" :class="{ 'ms-collapse': isCollapsed }">
        <div class="menu-items relative">
            ...
            <div class="menu-group-items"
                ...
                <div class="sub-menu"
                    :style="{ height: groupExpandIndex === GROUP_PLAN_INDEX ? `${calculateSubmenuHeight(GROUP_PLAN_INDEX)}px` : '0' }">
            ...
            <div class="menu-group-items"
                ...
                <div class="sub-menu"
                    :style="{ height: groupExpandIndex === GROUP_EXECUTION_INDEX ? `${calculateSubmenuHeight(GROUP_EXECUTION_INDEX)}px` : '0' }">
                    ...
                    <div class="sub-menu__item relative group" @mouseover="handoverSubmenuOpen = true" :class="{
                    ...
                    }" @mouseleave="closeHandoverSubmenu">
                        <div class="sub-menu__item__text">Bàn giao bán thành phẩm</div>
                        <div class="icon-menu mi-warehouse icon20 icon-chevron-right"></div>
                        <!-- Sub-menu panel for handover  -->
                        <div v-if="handoverSubmenuOpen" @mouseover="isHoveringHandoverMenu = true"
                            @mouseleave="isHoveringHandoverMenu = false"
                            class="sub-menu-panel absolute top-0 left-full ml-6 w-max bg-white p-2 z-10000 transition-opacity">
            ...
            <div class="menu-group-items"
                ...
                <div class="sub-menu"
                    :style="{ height: groupExpandIndex === GROUP_PRODUCT_QUALITY_INDEX ? `${calculateSubmenuHeight(GROUP_PRODUCT_QUALITY_INDEX)}px` : '0' }">
                    ...
                    }" @mouseover="productQualitySubmenuOpen = true" @mouseleave="closeProductQualitySubmenu">
                        <div class="sub-menu__item__text">Tiêu chuẩn</div>
                        <div class="icon-menu mi-warehouse icon20 icon-chevron-right"></div>
                        <!-- Sub-menu panel for handover  -->
                        <div v-if="productQualitySubmenuOpen" @mouseover="isHoveringProductQualityMenu = true"
                            @mouseleave="isHoveringProductQualityMenu = false"
                            class="sub-menu-panel absolute top-0 left-full ml-6 w-max bg-white p-2 z-10000 transition-opacity">
                            <div class="sub-menu-panel__section">
            ...
            <div class="menu-group-items"
                ...
                <div class="sub-menu"
                    :style="{ height: groupExpandIndex === GROUP_PRODUCTION_MATERIAL_INDEX ? `${calculateSubmenuHeight(GROUP_PRODUCTION_MATERIAL_INDEX)}px` : '0' }">
            ...
            <div class="menu-group-items"
                ...
                <div class="sub-menu"
                    :style="{ height: groupExpandIndex === GROUP_DICTIONARY_INDEX ? `${calculateSubmenuHeight(GROUP_DICTIONARY_INDEX)}px` : '0' }">
            ...
            <div class="menu-group-items"
                ...
                <div class="sub-menu"
                    :style="{ height: groupExpandIndex === GROUP_PRODUCTION_PROCESS_INDEX ? `${calculateSubmenuHeight(GROUP_PRODUCTION_PROCESS_INDEX)}px` : '0' }">
            ...
            <div class="menu-group-items"
                ...
                <div class="sub-menu"
                    :style="{ height: groupExpandIndex === GROUP_PRODUCTION_CAPACITY_INDEX ? `${calculateSubmenuHeight(GROUP_PRODUCTION_CAPACITY_INDEX)}px` : '0' }">
            ...
            <div class="menu-group-items relative group" @mouseover="productOtherCategorySubmenuOpen = true"
                @mouseleave="closeProductOtherCategorySubmenu"
                ...
                <!-- Sub-menu panel for handover  -->
                <div v-if="productOtherCategorySubmenuOpen" @mouseover="isHoveringProductOtherCategoryMenu = true"
                    @mouseleave="isHoveringProductOtherCategoryMenu = false"
                    class="sub-menu-panel absolute top-0 left-full ml-6 w-max bg-white p-2 z-10000 transition-opacity">
                    <div class="flex gap-2">
                        ...
                        <div class="sub-menu-panel__section">
                            ...
                            <router-link to="/production/other-categories/work-schedule" class="sub-menu-panel__item">
                                <div class="sub-menu-panel__item__text">Lịch làm việc</div>
                            </router-link>
                        </div>
                        <div class="sub-menu-panel__section">
                            <div class="sub-menu-panel__title">Khác</div>
                            <router-link to="/production/other-categories/organization" class="sub-menu-panel__item">
